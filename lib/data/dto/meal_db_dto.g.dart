...
MealSearchResponseDto _$MealSearchResponseDtoFromJson(
...
Map<String, dynamic> _$MealSearchResponseDtoToJson(
  MealSearchResponseDto instance,
) => <String, dynamic>{'meals': instance.meals};

MealRandomResponseDto _$MealRandomResponseDtoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$MealRandomResponseDtoToJson(
  MealRandomResponseDto instance,
) => <String, dynamic>{'meals': instance.meals};

MealFilterResponseDto _$MealFilterResponseDtoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$MealFilterResponseDtoToJson(
  MealFilterResponseDto instance,
) => <String, dynamic>{'meals': instance.meals};
...
CategoryDto _$CategoryDtoFromJson(Map<String, dynamic> json) =>
    CategoryDto(strCategory: json['strCategory'] as String?);
