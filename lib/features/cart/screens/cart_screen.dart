        ...
        itemBuilder: (context, index) {
          ...
          return CartItemWidget(
            ...
            onIncrement: () {
              ...
              appState.onCartUpdate(updated); // Обновляем состояние
            },
            onDecrement: () {
      ...
      bottomSheet: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Логика просмотра истории заказов
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('История заказов пока недоступна')),
                );
              },
